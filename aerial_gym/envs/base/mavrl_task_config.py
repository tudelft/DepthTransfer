...
class MAVRLTaskCfg(BaseConfig):
    ...
    class asset_config:
        ...
        include_env_bound_type = {
            ...
            "left_wall_forest": True,
            "right_wall_forest": True,
            "front_wall_forest": True,
            "back_wall_forest": True,
            }
