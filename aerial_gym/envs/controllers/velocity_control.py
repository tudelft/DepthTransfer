...
class LeeVelocityController:
    ...
    def randomize_params(self, env_ids=None):
        ...
        self.K_vel_tensor_current[env_ids] = (self.K_vel_tensor + ((torch.rand_like(self.K_vel_tensor) - 0.5) * 2) * 0.014)[env_ids]
        ...
        # self.K_angvel_tensor_current[env_ids, 2] = (self.K_angvel_tensor + ((torch.rand_like(self.K_angvel_tensor) - 0.5) * 2) * 0.12)[env_ids, 2]
    ...
    def __call__(self, robot_state, command_actions):
        ...
        accel_command = self.K_vel_tensor_current * vel_error
        accel_command[:, 2] += 1
