...
class WaypointData:
    ...
    def from_waypoint_list(
        cls, num_envs: int, waypoint_list: List[Waypoint], append_dummy: bool = False
    ):
        waypoint_list = waypoint_list.copy()
        if append_dummy:
            waypoint_list.append(waypoint_list[-1])
            waypoint_list[-1].gate = False
        ...
        for i in range(num_waypoints):
            ...
            if i > 0:
                ...
                end_mat = p3d_transforms.quaternion_to_matrix(end_q.roll(1))
