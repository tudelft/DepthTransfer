...
class EnvCreator:
    ...
    def create(self, drone_asset, drone_position: List[float]):
        """
        Creates envs, actors.
        ...
        for i in tqdm(range(self.params.num_envs), disable=self.params.disable_tqdm):
            ...
            env = self.gym.create_env(
                ...
                Vec3(env_size / 2, env_size / 2, env_size / 2.0),
            ...
            quad_actor = self.gym.create_actor(env, drone_asset, tf, "drone", i, 0)
