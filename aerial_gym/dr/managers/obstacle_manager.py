...
class ObstacleManager:
    ...
    def compute(
        ...
        # TODO: whoa! nested loops! what have I done?
            ...
            for wp_id in [1, 2]:
                for bar_id in range(4):
                    if enable_gate[env_id, wp_id]:
                        ...
                        wp_mat = p3d_transforms.quaternion_to_matrix(wp_q.roll(1))
                        wp_axis_y = wp_mat[:, 1]
                        wp_axis_z = wp_mat[:, 2]
        ...
        for i in range(self.num_envs):
            ...
            for j in range(2):
                ...
                local_coord_mat = p3d_transforms.quaternion_to_matrix(q.roll(1))
